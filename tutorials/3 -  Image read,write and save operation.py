...
# img1 = cv2.imread(r'data\avengers.jpg',1)  
...
#Now read image 
img1 = cv2.imread(r'data\avengers.jpg',0) #convert image into grayscale
...
if k == ord("q"):
    ...
    cv2.imwrite(r"data\\ouput.png",img1)  #it accept name of image and data
    cv2.destroyAllWindows()
